// Stan model to fit type II FR with temperature dependence no interference
//

// Input data: Number of surveys, Number of feeding events, total number of spiders
// detection times, and prey densities
data {
